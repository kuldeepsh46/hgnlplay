...
<section class="common-section login-section">
    <div class="login-container">
        <div class="brand">
            <div class="logo">
                <a href="/">
                    <img src="/storage/logo.jpeg" alt="Himalaya Trading">
                </a>
            </div>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-group">
                ...
                <input id="member_id" type="text" class="form-control <?php $__errorArgs = ['member_id'];
...
unset($__errorArgs, $__bag); ?>" 
                    name="member_id" value="<?php echo e(old('member_id')); ?>" placeholder="e.g. HGNL10001" required autofocus>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kuldeepsharma/Projects/hgnlplay/resources/views/auth/login.blade.php ENDPATH**/ ?>