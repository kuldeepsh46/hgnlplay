...
<div class="profile-header">
    <h1>My Profile</h1>
    <span class="profile-user">👤 <?php echo e($user->username ?? $user->name); ?></span>
</div>
...
<div class="profile-card">
    ...
    <div class="profile-grid">
        ...
        <div class="profile-item">
            ...
            <p><?php echo e($user->pan_number); ?></p>
        </div>

        <div class="profile-item">
            <label>State</label>
            <p><?php echo e($user->state); ?></p>
        </div>
        ...
        <div class="profile-item">
            ...
            <p><?php echo e($user->sponsor_id); ?></p>
        </div>

        <div class="profile-item">
            <label>Sponsor Name</label>
            <p><?php echo e($user->sponsor_name); ?></p>
        </div>

        <div class="profile-item">
            <label>Position</label>
            <p><?php echo e(ucfirst($user->position)); ?></p>
        </div>

        <div class="profile-item highlight">
            <label>Wallet Balance</label>
            <p>₹ <?php echo e(number_format($user->wallet_balance, 2)); ?></p>
        </div>
    </div>
...
<div id="passwordModal" class="modal">
    <div class="modal-content">
        ...
        <?php if(session('error')): ?>
            <p class="error-msg"><?php echo e(session('error')); ?></p>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('common.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kuldeepsharma/Projects/hgnlplay/resources/views/profile.blade.php ENDPATH**/ ?>