...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/admin/user/update-password', [DashboardController::class, 'updateUserPassword'])
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/changep/update', [ProfileController::class, 'updatePassword'])
    ->name('changep.update');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/team/direct-referral', [TreeController::class, 'directReferral'])
    ->name('team.direct');

    Route::get('/team/total-downline', [TreeController::class, 'totalDownline'])
    ->name('team.total');

    Route::get('/team/team-level', [TreeController::class, 'teamLevelDownline'])
    ->name('team.level');
...
Route::get('/team-tree', [TreeController::class, 'index'])
     ->name('team.tree');
