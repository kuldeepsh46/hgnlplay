...
<aside class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li class="{{ request()->routeIs('profile') || request()->routeIs('profile.edit') || request()->routeIs('profile.kyc') ? 'active' : '' }}"
            ...
            <ul
                ...
                <li class="{{ request()->routeIs('profile') ? 'active' : '' }}">
                    <a href="{{ route('profile') }}" style="text-decoration:none; color:inherit; display:block;">View
                        Profile</a>
                </li>
        ...
        <li
            class="team-item {{ request()->routeIs('tree','team.list','team.direct','team.total','team.level') ? 'active open' : '' }}" style="display:block;padding:0px;">
            <div class="team-menu">
        ...
        <a href="{{ route('wallet.fund') }}" style="text-decoration:none;color:inherit;display:block;">
            <li class="{{ Request::routeIs('wallet.fund') ? 'active' : '' }}">💰 <span>Wallet Fund Request</span></li>
        </a>
        ...
        <a href="{{ route('admin.payments') }}" style="text-decoration:none;color:inherit;display:block;">
            <li class="{{ Request::routeIs('admin.payments') ? 'active' : '' }}">💳 <span>Manage Payments</span></li>
        </a>
        ...
        <a href="{{ route('admin.support') }}" style="text-decoration:none;color:inherit;display:block;">
            <li class="{{ Request::routeIs('admin.support') ? 'active' : '' }}">🆘 <span>Support Request</span></li>
        </a>
