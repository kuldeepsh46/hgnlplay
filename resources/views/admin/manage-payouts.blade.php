...
<div class="card">
    <form method="GET" class="filter-form">
        ...
        <a href="{{ route('admin.payouts') }}" class="tab-btn" style="background:#333;color:#fff;">Reset</a>
    </form>

    <div class="tabs">
        <button class="tab-btn active" id="tabAll">All Payouts</button>
        <button class="tab-btn" id="tabPending">Payout Requests</button>
        <button class="tab-btn" id="tabCompleted">Completed Payouts</button>
    </div>

    <div id="allTab" class="table-wrap">@include('admin.partials.payout-table', ['data'=>$all])</div>
    <div id="pendingTab" class="table-wrap" style="display:none;">@include('admin.partials.payout-table',
        ['data'=>$pending, 'pending'=>true])</div>
    <div id="completedTab" class="table-wrap" style="display:none;">@include('admin.partials.payout-table',
        ['data'=>$completed])</div>
</div>
