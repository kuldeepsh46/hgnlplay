...
<div class="card">
    ...
    <div id="matchingTab">
        <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <a href="{{ route('reports.export','matching') }}" class="btn btn-copy">⬇ Export CSV</a>
        </div>
        <div class="table-wrap">
            <table>
                ...
                <tbody>
                    @forelse($matchingIncomes as $i => $r)
                    <tr>
                        <td>{{ $i + 1 }}</td>
    ...
    <div id="directTab" style="display:none;">
        <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <a href="{{ route('reports.export','direct') }}" class="btn btn-copy">⬇ Export CSV</a>
        </div>
        <div class="table-wrap">
            <table>
                <thead>
